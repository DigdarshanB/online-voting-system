  ...
  return (
    <PageContainer>
      ...
      <AdminPageHeader
        ...
        subtitle={`${localElections.length} election(s) available`}
        action={
      ...
      <AdminPortalHero
        ...
        title="Local Result Tallies"
        subtitle="Review Mayor, Deputy Mayor, Ward Chair, and member election results across all municipal and rural municipal bodies."
        ...
        rightContent={
          <div className="admin-hero-chips" style={{ display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'flex-end' }}>
            <AdminHeroChip label={`${localElections.length} elections`} tint="info" />
